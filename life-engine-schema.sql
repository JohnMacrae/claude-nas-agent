-- Life Engine schema for the claude-nas-agent
-- Run this in the Open Brain Supabase SQL Editor:
-- https://tvoyukxvvgdambudjdbq.supabase.co
--
-- All tables use UUIDs and timestamptz.
-- RLS is enabled on each table; the agent accesses via service key which bypasses RLS.
...
CREATE TABLE IF NOT EXISTS life_engine_checkins (
  ...
  raw_text     TEXT,       -- John's raw Telegram reply
  notes        TEXT
);
...
-- ============================================================
-- Seed: initial habits
-- Edit as preferred before running.
-- ============================================================
